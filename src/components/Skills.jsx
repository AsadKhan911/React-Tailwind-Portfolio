...
import { DiHtml5, DiCss3, DiJavascript1, DiReact, DiNodejsSmall, DiMongodb, DiGithubBadge, DiLaravel, DiMysql } from 'react-icons/di';
...
const skills = [
    ...
    },
    {
        category: 'Backend',
        technologies: [
            { name: 'Node', icon: <DiNodejsSmall className='text-green-600' /> },
