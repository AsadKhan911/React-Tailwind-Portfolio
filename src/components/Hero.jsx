...
import { SiExpress, SiNextdotjs, SiTailwindcss, SiTypescript } from 'react-icons/si';
    ...
    return (
        ...
        <div className='mt-36 md:mt-24 max-w-[1200px] mx-auto relative'>
            ...
            >
                ...
                <div className='flex flex-row justify-center items-center flex-wrap gap-4 text-4xl md:text-7xl'>
                    <DiMongodb className='text-green-600 mx-2' />
                    <SiExpress className='text-yellow-500 mx-2' />
                    <DiReact className='text-blue-500 mx-2' />
                    <DiNodejsSmall className='text-green-500 mx-2' />
                    <SiNextdotjs className='text-gray-300 mx-2' />
                </div>
